...
type SubscriptionInfoResponseObject struct {
	// The list of plans that were used to subscribe to the multitenant application.
	CurrentlyUsedPlans []SaasSubscriptionPlanDto `json:"currentlyUsedPlans,omitempty"`
}
