	...
	t.Run("happy path", func(t *testing.T) {
		...
		resource.Test(t, resource.TestCase{
			...
			Steps: []resource.TestStep{
				{
					Config: hclProvider() + hclDatasourceSubaccountUser("someone", "5381d6a4-d67f-45b1-93a0-624876f74d03", "jenny.doe@test.com", "sap.default"),
					Check: resource.ComposeAggregateTestCheckFunc(
						resource.TestCheckResourceAttr("data.btp_subaccount_user.someone", "subaccount_id", "5381d6a4-d67f-45b1-93a0-624876f74d03"),
						resource.TestCheckResourceAttr("data.btp_subaccount_user.someone", "user_name", "jenny.doe@test.com"),
						resource.TestCheckResourceAttr("data.btp_subaccount_user.someone", "origin", "sap.default"),
						resource.TestCheckResourceAttr("data.btp_subaccount_user.someone", "active", "true"),
						resource.TestCheckResourceAttr("data.btp_subaccount_user.someone", "family_name", "unknown"),
						resource.TestCheckResourceAttr("data.btp_subaccount_user.someone", "given_name", "unknown"),
						resource.TestCheckResourceAttr("data.btp_subaccount_user.someone", "id", "de350a51-fa8f-4bdf-bd75-79179b846911"),
						resource.TestCheckResourceAttr("data.btp_subaccount_user.someone", "role_collections.#", "0"),
						resource.TestCheckResourceAttr("data.btp_subaccount_user.someone", "verified", "false"),
					),
				},
			},
		})
