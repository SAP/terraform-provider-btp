...
type subaccountRoleCollectionRoleReferences struct {
	/* OUTPUT */
...
type subaccountRoleCollectionDataSourceConfig struct {
	...
	Description    types.String                             `tfsdk:"description"`
	RoleReferences []subaccountRoleCollectionRoleReferences `tfsdk:"role_references"`
}
...
func (ds *subaccountRoleCollectionDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: `Get details about a specific subaccount role collection.`,
...
func (ds *subaccountRoleCollectionDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	data.RoleReferences = []subaccountRoleCollectionRoleReferences{}

	for _, ref := range rolecollection.RoleReferences {
		data.RoleReferences = append(data.RoleReferences, subaccountRoleCollectionRoleReferences{
