...
func TestDataSourceSubaccountServiceInstancess(t *testing.T) {
	...
	t.Run("happy path - service instances for subaccount", func(t *testing.T) {
		rec := setupVCR(t, "fixtures/datasource_subaccount_service_instances_all")
		...
		resource.Test(t, resource.TestCase{
			...
			Steps: []resource.TestStep{
				{
					Config: hclProvider() + hclDatasourceSubaccountServiceInstanceBySubaccount("uut", "59cd458e-e66e-4b60-b6d8-8f219379f9a5"),
	...
	t.Run("happy path - service instances for subaccount with fields filter", func(t *testing.T) {
		rec := setupVCR(t, "fixtures/datasource_subaccount_service_instances_namefilter")
		defer stopQuietly(rec)
		...
		resource.Test(t, resource.TestCase{
			...
			Steps: []resource.TestStep{
				{
					Config: hclProvider() + hclDatasourceSubaccountInstancesBySubaccountAndFields("uut", "59cd458e-e66e-4b60-b6d8-8f219379f9a5", "false"),
					Check: resource.ComposeAggregateTestCheckFunc(
						resource.TestCheckResourceAttr("data.btp_subaccount_service_instances.uut", "subaccount_id", "59cd458e-e66e-4b60-b6d8-8f219379f9a5"),
	...
	t.Run("happy path - service instances for subaccount with fields filter (variant)", func(t *testing.T) {
		rec := setupVCR(t, "fixtures/datasource_subaccount_service_instances_namefilter_variant")
		defer stopQuietly(rec)
		...
		resource.Test(t, resource.TestCase{
			...
			Steps: []resource.TestStep{
				{
					Config: hclProvider() + hclDatasourceSubaccountInstancesBySubaccountAndFields("uut", "59cd458e-e66e-4b60-b6d8-8f219379f9a5", "true"),
					Check: resource.ComposeAggregateTestCheckFunc(
						resource.TestCheckResourceAttr("data.btp_subaccount_service_instances.uut", "subaccount_id", "59cd458e-e66e-4b60-b6d8-8f219379f9a5"),
						resource.TestCheckResourceAttr("data.btp_subaccount_service_instances.uut", "values.#", "2"),
					),
	...
	t.Run("happy path - service instances for subaccount with labels filter", func(t *testing.T) {
		rec := setupVCR(t, "fixtures/datasource_subaccount_service_instances_labelsfilter")
		defer stopQuietly(rec)
		...
		resource.Test(t, resource.TestCase{
			...
			Steps: []resource.TestStep{
				{
					Config: hclProvider() + hclDatasourceSubaccountInstancesBySubaccountAndLabels("uut", "59cd458e-e66e-4b60-b6d8-8f219379f9a5"),
					Check: resource.ComposeAggregateTestCheckFunc(
						resource.TestCheckResourceAttr("data.btp_subaccount_service_instances.uut", "subaccount_id", "59cd458e-e66e-4b60-b6d8-8f219379f9a5"),
	...
	t.Run("error path - subaccount_id mandatory", func(t *testing.T) {
		resource.Test(t, resource.TestCase{
			...
			Steps: []resource.TestStep{
				{
					Config:      hclProvider() + `data "btp_subaccount_service_instances" "uut" {}`,
	...
	t.Run("error path - subaccount_id not a valid UUID", func(t *testing.T) {
		resource.Test(t, resource.TestCase{
			...
			Steps: []resource.TestStep{
				{
					Config:      hclProvider() + hclDatasourceSubaccountServiceInstanceBySubaccount("uut", "this-is-not-a-uuid"),
