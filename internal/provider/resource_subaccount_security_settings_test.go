	...
	t.Run("happy path - complete configuration", func(t *testing.T) {
		...
		resource.Test(t, resource.TestCase{
			...
			Steps: []resource.TestStep{
				{
					Config: hclProviderFor(user) + hclResourceSubaccountSecuritySettings("uut", "ef23ace8-6ade-4d78-9c1f-8df729548bbf", "terraformint.accounts400.ondemand.com", 3601, 3602, true, "[\"domain1.test\",\"domain2.test\"]"),
