...
func hclDatasourceSubaccountRoleCollections(resourceName string, id string) string {
	return fmt.Sprintf(`data "btp_subaccount_role_collections" "%s" { subaccount_id = "%s" }`, resourceName, id)
}
