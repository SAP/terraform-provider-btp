	...
	t.Run("happy path", func(t *testing.T) {
		...
		resource.Test(t, resource.TestCase{
			...
			Steps: []resource.TestStep{
				{
					Config: hclProvider() + hclDatasourceDirectoryUser("someone", "05368777-4934-41e8-9f3c-6ec5f4d564b9", "jenny.doe@test.com", "sap.default"),
					Check: resource.ComposeAggregateTestCheckFunc(
						resource.TestCheckResourceAttr("data.btp_directory_user.someone", "directory_id", "05368777-4934-41e8-9f3c-6ec5f4d564b9"),
						resource.TestCheckResourceAttr("data.btp_directory_user.someone", "user_name", "jenny.doe@test.com"),
						resource.TestCheckResourceAttr("data.btp_directory_user.someone", "origin", "sap.default"),
						resource.TestCheckResourceAttr("data.btp_directory_user.someone", "active", "false"),
						resource.TestCheckResourceAttr("data.btp_directory_user.someone", "family_name", ""),
						resource.TestCheckResourceAttr("data.btp_directory_user.someone", "given_name", ""),
						resource.TestCheckResourceAttr("data.btp_directory_user.someone", "id", ""),
						resource.TestCheckResourceAttr("data.btp_directory_user.someone", "role_collections.#", "0"),
						resource.TestCheckResourceAttr("data.btp_directory_user.someone", "verified", "false"),
					),
				},
			},
		})
