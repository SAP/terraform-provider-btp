	...
	t.Run("happy path", func(t *testing.T) {
		...
		resource.Test(t, resource.TestCase{
			...
			Steps: []resource.TestStep{
				{
					Config: hclProvider() + hclDatasourceGlobalaccountUser("someone", "jenny.doe@test.com", "sap.default"),
					Check: resource.ComposeAggregateTestCheckFunc(
						resource.TestCheckResourceAttr("data.btp_globalaccount_user.someone", "user_name", "jenny.doe@test.com"),
						resource.TestCheckResourceAttr("data.btp_globalaccount_user.someone", "origin", "sap.default"),
						resource.TestCheckResourceAttr("data.btp_globalaccount_user.someone", "active", "true"),
						resource.TestCheckResourceAttr("data.btp_globalaccount_user.someone", "family_name", "unknown"),
						resource.TestCheckResourceAttr("data.btp_globalaccount_user.someone", "given_name", "unknown"),
						resource.TestCheckResourceAttr("data.btp_globalaccount_user.someone", "id", "86535387-54aa-4282-af13-67dd50cdd13c"),
						resource.TestCheckResourceAttr("data.btp_globalaccount_user.someone", "role_collections.#", "2"),
						resource.TestCheckResourceAttr("data.btp_globalaccount_user.someone", "verified", "false"),
					),
				},
			},
		})
