...
page_title: "btp_subaccount_destination_fragment List Resource - SAP BTP"
subcategory: ""
description: |-
  This list resource allows you to discover all destination fragments available for given subaccount.
---

# btp_subaccount_destination_fragment (List Resource)
