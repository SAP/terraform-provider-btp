...
page_title: "btp_directory_entitlement List Resource - SAP BTP"
subcategory: ""
description: |-
  This list resource allows you to discover all entitlements available within a specific BTP Directory. It requires the directory ID as input.
---

# btp_directory_entitlement (List Resource)
