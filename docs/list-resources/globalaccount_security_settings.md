...
page_title: "btp_globalaccount_security_settings List Resource - SAP BTP"
subcategory: ""
description: |-
  This list resource allows you to discover all security settings available for given global account.
---

# btp_globalaccount_security_settings (List Resource)
