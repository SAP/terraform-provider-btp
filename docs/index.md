...
The documententation of each resource shows if the resource can be imported and whoch keys are needed. To provide a quick overview we listed the resources in the [Terraform provider repository](https://github.com/SAP/terraform-provider-btp/blob/main/tech-docs/IMPORT.md).
