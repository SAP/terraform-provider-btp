		...
		Attributes: map[string]schema.Attribute{
			...
			"geo_access": schema.StringAttribute{
				MarkdownDescription: "The geographic locations from where the global account can be accessed. Possible values are: \n" +
					getFormattedValueAsTableRow("value", "description") +
					getFormattedValueAsTableRow("---", "---") +
					getFormattedValueAsTableRow("`STANDARD`", "The global account can be accessed from any geographic location.") +
					getFormattedValueAsTableRow("`EU_ACCESS`", "The global account can be accessed only within locations in the EU."),
				Computed: true,
			},
			"license_type": schema.StringAttribute{
				MarkdownDescription: "The type of license for the global account. The license type affects the scope of functions of the account. Possible values are: \n" +
					...
					getFormattedValueAsTableRow("---", "---") +
					getFormattedValueAsTableRow("`DEVELOPER` ", "For internal developer global accounts on Staging or Canary landscapes.") +
					getFormattedValueAsTableRow("`CUSTOMER`", "For customer global accounts.") +
					getFormattedValueAsTableRow("`PARTNER`", "For partner global accounts.") +
					getFormattedValueAsTableRow("`INTERNAL_DEV`", "For internal global accounts on the Dev landscape. ") +
					getFormattedValueAsTableRow("`INTERNAL_PROD`", "For internal global accounts on the Live landscape.") +
					getFormattedValueAsTableRow("`TRIAL`", "For customer trial accounts."),
				Computed: true,
			},
			"origin": schema.StringAttribute{
				MarkdownDescription: "The origin of the account. Possible values are: \n" +
					getFormattedValueAsTableRow("origin", "description") +
					getFormattedValueAsTableRow("---", "---") +
					getFormattedValueAsTableRow("`ORDER`", "Created by the Order Processing API or Submit Order wizard.") +
					getFormattedValueAsTableRow("`OPERATOR`", "Created by the Global Account wizard.") +
					getFormattedValueAsTableRow("`REGION_SETUP`", "Created automatically as part of the region setup."),
				Computed: true,
			},
			...
			"usage": schema.StringAttribute{
				MarkdownDescription: "For internal accounts, the intended purpose of the global account. Possible values are: \n" +
					getFormattedValueAsTableRow("usage", "description") +
					getFormattedValueAsTableRow("---", "---") +
					getFormattedValueAsTableRow("`Development`", "For testing development.") +
					getFormattedValueAsTableRow("`Testing`", "For testing development.") +
					getFormattedValueAsTableRow("`Demo`", "For creating demos.") +
					getFormattedValueAsTableRow("`Production` ", "For delivering a service in a production landscape."),
				Computed: true,
			},
