			...
			Steps: []resource.TestStep{
				{
					...
					Check: resource.ComposeAggregateTestCheckFunc(
						...
						resource.TestCheckResourceAttr("data.btp_subaccount_security_settings.uut", "iframe_domains_list.#", "0"),
						resource.TestCheckResourceAttr("data.btp_subaccount_security_settings.uut", "use_idp_user_name_in_tokens", "true"),
						resource.TestCheckResourceAttr("data.btp_subaccount_security_settings.uut", "auto_rotate_signing_key", "true"),
						resource.TestCheckResourceAttr("data.btp_subaccount_security_settings.uut", "home_redirect_url", "https://www.sap.com"),
					),
				},
			},
		})
