...
type subaccountEnvironmentInstanceDataSourceType struct {
	SubaccountId    types.String `tfsdk:"subaccount_id"`
	Id              types.String `tfsdk:"id"`
	BrokerId        types.String `tfsdk:"broker_id"`
	CreatedDate     types.String `tfsdk:"created_date"`
...
func subaccountEnvironmentInstanceDataSourceValueFrom(ctx context.Context, value provisioning.EnvironmentInstanceResponseObject) (subaccountEnvironmentInstanceDataSourceType, diag.Diagnostics) {
	environmentInstanceDataSource := subaccountEnvironmentInstanceDataSourceType{
		Id:              types.StringValue(value.Id),
		BrokerId:        types.StringValue(value.BrokerId),
		CreatedDate:     timeToValue(value.CreatedDate.Time()),
		DashboardUrl:    types.StringValue(value.DashboardUrl),
	...
	environmentInstanceDataSource.CustomLabels, diags = types.MapValueFrom(ctx, types.SetType{ElemType: types.StringType}, value.CustomLabels)
	diagnostics.Append(diags...)
