...
var _ list.ListResourceWithConfigure = &GlobalaccountRoleCollectionListResource{}

type GlobalaccountRoleCollectionListResource struct {
	client *btpcli.ClientFacade
}

func NewGlobalaccountRoleCollectionListResource() list.ListResource {
	return &GlobalaccountRoleCollectionListResource{}
}

func (r *GlobalaccountRoleCollectionListResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_globalaccount_role_collection" // must match managed resource
}

func (r *GlobalaccountRoleCollectionListResource) Configure(_ context.Context,
...
func (r *GlobalaccountRoleCollectionListResource) ListResourceConfigSchema(
	_ context.Context,
...
func (r *GlobalaccountRoleCollectionListResource) List(
	ctx context.Context,
