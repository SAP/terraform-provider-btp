			...
			Steps: []resource.TestStep{
				{
					...
					Check: resource.ComposeAggregateTestCheckFunc(
						...
						resource.TestCheckResourceAttr("data.btp_globalaccount_with_hierarchy.globalaccount_canary", "directories.4.parent_name", "terraform-integration-canary"),
						//directory: integration-test-dir-entitlements-stacked 's parent --> integration-test-dir-entitlements
						resource.TestCheckResourceAttr("data.btp_globalaccount_with_hierarchy.globalaccount_canary", "directories.4.directories.0.parent_name", "integration-test-dir-entitlements"),
						//subaccount: integration-test-acc-entitlements-stacked 's parent --> integration-test-dir-entitlements-stacked
						resource.TestCheckResourceAttr("data.btp_globalaccount_with_hierarchy.globalaccount_canary", "directories.4.directories.0.subaccounts.0.parent_name", "integration-test-dir-entitlements-stacked"),
